...
export default function FeatureBlock() {
  ...
  return (
    <section id="engine" className="py-16 md:py-32 px-4 md:px-6 bg-transparent relative">
      <div ref={ref} className="max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          className="relative bg-gradient-to-b from-white/90 via-white/70 to-white/90 dark:from-[#151518]/90 dark:via-[#111113]/70 dark:to-[#151518]/90 rounded-2xl md:rounded-3xl overflow-hidden shadow-2xl backdrop-blur-xl border border-gray-200/70 dark:border-white/10 mb-12 md:mb-20"
        >
          <div className="p-6 sm:p-8 md:p-12 lg:p-16 relative z-10">
            ...
            >
              ...
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed">
                Eraco is an <span className="font-semibold text-gray-900 dark:text-white">adaptive AI assistant</span> and advanced <span className="font-semibold text-gray-900 dark:text-white">LLM</span> that can do everything other AIs can do while being fundamentally better. It works alongside you — understanding your intent, learning your workflows, and getting more capable with every interaction.
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8 md:mb-12">
              {[
                ...
                <motion.div
                  ...
                  className="p-5 sm:p-6 rounded-xl sm:rounded-2xl bg-white/70 dark:bg-white/[0.04] backdrop-blur-md border border-gray-200/60 dark:border-white/[0.08] hover:border-orange-500/40 hover:dark:border-orange-500/40 transition-all duration-300 shadow-sm"
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8 pt-6 md:pt-8">
              {[
                ...
                <motion.div
                  ...
                  className="text-center p-5 sm:p-6 rounded-xl sm:rounded-2xl bg-white/70 dark:bg-white/[0.04] backdrop-blur-md border border-gray-200/60 dark:border-white/[0.08] hover:border-orange-500/40 hover:dark:border-orange-500/40 transition-all duration-300 shadow-sm"
                >
        ...
        <motion.div
          ...
          className="relative bg-gradient-to-b from-white/90 via-white/70 to-white/90 dark:from-[#151518]/90 dark:via-[#111113]/70 dark:to-[#151518]/90 rounded-2xl md:rounded-3xl overflow-hidden shadow-2xl backdrop-blur-xl border border-gray-200/70 dark:border-white/10"
        >
          <div className="p-6 sm:p-8 md:p-12 lg:p-16 relative z-10">
            ...
            >
              ...
              <div className="relative rounded-2xl md:rounded-3xl overflow-hidden shadow-inner bg-gradient-to-b from-gray-100 to-gray-200/80 dark:from-[#0c0c0e] dark:to-[#131316] border border-gray-200/60 dark:border-white/[0.06] aspect-video max-w-full">
                {/* Product video placeholder with smooth ambient gradient */}
                <div className="absolute inset-0 flex items-center justify-center bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-orange-500/10 via-transparent to-transparent">
                  <div className="text-center px-4">
                    <motion.div
                      ...
                      className="w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-xl sm:rounded-2xl bg-gradient-to-br from-orange-400 to-orange-600 flex items-center justify-center mx-auto mb-4 sm:mb-6 shadow-lg shadow-orange-500/20"
                    >
                      <svg className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-white ml-1" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M8 5v14l11-7z"/>
                      </svg>
                    </motion.div>
                    <p className="text-gray-600 dark:text-gray-400 text-sm sm:text-base font-medium">SaaS Explainer Video</p>
            ...
            >
              ...
              <div className="relative rounded-2xl md:rounded-3xl overflow-hidden shadow-inner bg-gradient-to-b from-gray-100 to-gray-200/80 dark:from-[#0c0c0e] dark:to-[#131316] border border-gray-200/60 dark:border-white/[0.06] aspect-video max-w-full">
                {/* Demo video placeholder with smooth ambient gradient */}
                <div className="absolute inset-0 flex items-center justify-center bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-orange-500/10 via-transparent to-transparent">
                  <div className="text-center px-4">
                    <motion.div
                      animate={{
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-sm sm:text-base font-medium">Demo Video</p>
                    <p className="text-gray-500 dark:text-gray-500 text-xs sm:text-sm mt-1">Cooking right now</p>
                  </div>
                </div>
                {/* Subtle glow border */}
