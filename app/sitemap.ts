...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE}/compare`,                     priority: 0.8, changeFrequency: 'monthly', lastModified: new Date() },
    ...
    { url: `${BASE}/eraco-vs-chatgpt`,            priority: 0.7, changeFrequency: 'monthly', lastModified: new Date() },
    { url: `${BASE}/eraco-vs-gemini`,             priority: 0.7, changeFrequency: 'monthly', lastModified: new Date() },
    { url: `${BASE}/eraco-vs-grok`,               priority: 0.7, changeFrequency: 'monthly', lastModified: new Date() },
