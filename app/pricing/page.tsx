...
export default function PricingPage() {
  ...
  return (
    <main className="min-h-screen">
      ...
      {/* Consumer Plans */}
      <section ref={consumerRef} className={`py-20 px-4 md:px-6 ${isDark ? 'bg-black' : 'bg-white'}`}>
      ...
      {/* Add-on Credit Packs */}
      <section ref={addonsRef} className="py-24 px-4 md:px-6 pricing-addons-gradient">
        <div className="max-w-7xl mx-auto">
          <motion.h2
            initial={{ opacity: 0, filter: 'blur(10px)', y: 30 }}
